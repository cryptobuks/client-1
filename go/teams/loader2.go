...
func (l *TeamLoader) fillInStubbedLinks(ctx context.Context,
	state *keybase1.TeamData, needSeqnos []keybase1.Seqnos, proofSet *proofSetT) (*keybase1.TeamData, *proofSetT, error) {
...
func (l *TeamLoader) verifyLink(ctx context.Context,
	state *keybase1.TeamData, link *SCChainLink, proofSet *proofSet) (*proofSet, error) {
...
func (l *TeamLoader) checkParentChildOperations(ctx context.Context,
	parent teamID, parentChildOperations []*parentChildOperation) error {
...
func (l *TeamLoader) checkProofs(ctx context.Context,
	state *keybase1.TeamState, proofSet *proofSetT) error {
...
func (l *TeamLoader) addSecrets(ctx context.Context,
	state *keybase1.TeamState, box *TeamBox, prev Q, readerKeyMasks []keybase1.ReaderKeyMask) (*keybase1.TeamData, error) {
